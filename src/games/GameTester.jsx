        ...
        <div style={{ minHeight: "100vh", background: "linear-gradient(135deg, #0f0f23 0%, #16213e 50%, #1a1a3e 100%)", color: "white" }}>
            ...
            <footer style={{
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "10px", marginBottom: "8px", flexWrap: "wrap" }}>
                    ...
                    <span style={{ color: "#cbd5e1", fontWeight: 500 }}>EyeToolkit Games</span>
                </div>
                <div>© 2026 EyeToolkit Games · Apache-2.0 Licensed</div>
            </footer>
            ...
            <section id="privacy" style={{
                ...
                <p style={{ color: "#94a3b8", lineHeight: 1.7, fontSize: "14px", margin: "0 0 10px" }}>
                    EyeToolkit Games respects your privacy. This site runs entirely in your browser — we do not collect personal information, do not require accounts, and do not track your gameplay across the web.
                </p>
            ...
            <section id="terms" style={{
                ...
                <p style={{ color: "#94a3b8", lineHeight: 1.7, fontSize: "14px", margin: "0 0 10px" }}>
                    EyeToolkit Games is provided "as is" for free personal use. By using this site, you agree to the following:
                </p>
                <ul style={{ color: "#94a3b8", fontSize: "14px", lineHeight: 1.7, paddingLeft: "18px", margin: 0 }}>
