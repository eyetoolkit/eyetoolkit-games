...
const Bomberman = ({ onComplete }) => {
            ...
            setEnemies(prev => prev.map(e => {
                ...
                const dirs = [[-1, 0], [1, 0], [0, -1], [0, 1]].filter(([dr, dc]) => {
                    ...
                    return nr >= 0 && nr < SIZE && nc >= 0 && nc < SIZE &&
                        map[nr][nc] !== WALL && map[nr][nc] !== BRICK && map[nr][nc] !== BOMB;
                });
    ...
    const COLORS = {
        [EMPTY]: "rgba(255,255,255,0.03)", [WALL]: "#555",
        [BRICK]: "#8B6914", [BOMB]: "#333", [EXPLOSION]: "#FF6B6B",
    };
    ...
    return (
        <div style={{ height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "8px", color: "white" }}>
            ...
            <div style={{
                ...
                padding: "4px", background: "#0a0a1a", borderRadius: "8px",
                ...
                {map.flat().map((cell, idx) => {
                    ...
                    return (
                        <div key={idx} style={{
                            ...
                            background: COLORS[cell], display: "flex",
                            alignItems: "center", justifyContent: "center",
                            fontSize: "18px",
                        }}>
                            {isPlayer ? "😎" : enemy ? "👾" : cell === BOMB ? "💣" : cell === EXPLOSION ? "💥" : ""}
                        </div>
                    );
                })}
            </div>
