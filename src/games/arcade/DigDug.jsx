...
const DigDug = ({ onComplete }) => {
        ...
        const handleKey = (e) => {
            ...
            setPlayerPos(prev => {
                ...
                setMap(prevMap => {
                    ...
                    // Check if enemy at new position
    ...
    const CELL_COLORS = {
        [DIRT]: "#8B6914", [TUNNEL]: "#3a2a0a", [ENEMY]: "#FF6B6B", [PLAYER]: "#4D96FF",
    };
    ...
    return (
        <div style={{ height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "10px", color: "white" }}>
            ...
            <div style={{
                ...
                padding: "4px", background: "#1a1a0a", borderRadius: "8px",
                border: "2px solid rgba(255,255,255,0.1)",
            }}>
                {map.flat().map((cell, idx) => (
                    <div key={idx} style={{
                        width: CELL, height: CELL, borderRadius: "3px",
                        background: CELL_COLORS[cell] || CELL_COLORS[TUNNEL],
                        display: "flex", alignItems: "center", justifyContent: "center",
                        fontSize: cell === PLAYER ? "16px" : cell === ENEMY ? "14px" : "0",
                    }}>
                        {cell === PLAYER ? "⛏️" : cell === ENEMY ? "👾" : ""}
                    </div>
                ))}
            </div>
...
const dBtn = {
    width: 36, height: 36, fontSize: "14px",
